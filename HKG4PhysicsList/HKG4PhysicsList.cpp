...
Ghost::G4::HKG4PhysicsList::HKG4PhysicsList() : Tool() {}

bool Ghost::G4::HKG4PhysicsList::Initialise(std::string configfile, DataModel& data) {
...
bool Ghost::G4::HKG4PhysicsList::Execute() {
...
bool Ghost::G4::HKG4PhysicsList::Finalise() {
