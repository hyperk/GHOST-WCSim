...
namespace Ghost::G4 {
	...
	protected:
		...
		void AddParticleToSimulate(InitialParticleInfo & pinfo) {m_particles_to_simulate.push_back(pinfo);}
		...
		//! Store config info in the WCSimRootOptions. Will be replaced with a common way to store things in the DataModel
