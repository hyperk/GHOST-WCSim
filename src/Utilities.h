...
namespace Ghost::Utils {
	...
	*/
	...
	/*!
	    ...
	    \return A vector containing ntokens elements. Will be a vector of size 0 if no line can be found (e.g.
	   end of file, all lines are comments)
	*/
	...
	/*!
	    ...
	    \return A vector containing ntokens elements. Will be a vector of size 0 if either input is invalid.
	   If there are no separators found in input, will be a vector of size 1 containing the input string
	*/
